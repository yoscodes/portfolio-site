...
const timelineData = [
  { year: "2001年", text: "三重県に生まれる" },
  { year: "2020年", text: "医療系専門学校に入学" },
  { year: "2022年", text: "ITの可能性を感じ、学校を中退" },
  { year: "2023年", text: "独学でプログラミング学習開始" },
  { year: "現在", text: "React / Supabaseを中心に開発中" },
];
      ...
      >
        <div className="container px-5 py-24 mx-auto flex flex-col-reverse lg:flex-row items-center">
          ...
          <div className="mt-10 mb-2 lg:mt-0 lg:mb-0 lg:w-1/2 flex justify-center">
            <div className="bg-gradient-to-br from-white via-blue-50 to-white border rounded-lg shadow-lg p-6 w-full max-w-md">
